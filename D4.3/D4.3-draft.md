...
User presentation of checklist results is handled by the RO Portal \cite{D1.2v4} (section 4.1), alpha.and by checklist trafic-light service \cite{D1.2v4} (section 4.3).  The RO-enabled myExperiment^[http://alpha2.myexperiment.org/] uses the traffic light service to construct a progress bar and pop-up traffic-light displays \cite{D1.2v4} (section 4.3).
