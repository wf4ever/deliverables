...
Further information about installing and deploying the checklist service can be found at [https://github.com/wf4ever/ro-manager/blob/master/src/roweb/README.md]().
...
* Structure of the source code repository and how this maps to the software’s components is documented.
  * Yes, see [https://github.com/wf4ever/ro-manager/blob/master/src/roweb/README.md](https://github.com/wf4ever/ro-manager/blob/master/src/roweb/README.md)
