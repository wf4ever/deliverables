...
* Are the binary releases packaged for immediate use in a suitable archive format?
  ...
  * See also the [README file][checklist-service-readme]
...
* Are there relevant user documents?
  * Yes. See the [README file][checklist-service-readme] and linked documents.
...
* How easy is it to set up development environment to change the software?
  ...
  * See the [README file][checklist-service-readme] and linked documents.
...
* How easy is it to validate changes you’ve made? This includes building the software, getting, building and running tests.
  * Fairly easy: see the [README file][checklist-service-readme].
...
Further information about installing and deploying the checklist service can be found in the [checklist service software README file][checklist-service-readme].
...
* Web site has site map or index.
  * Yes, see [https://github.com/wf4ever/ro-manager]() which links to the [README file][checklist-service-readme] and linked documents.
