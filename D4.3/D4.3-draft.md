...
![Timings vs number of annotations for different annotation sizes \label{time_per_na}](figures/benchmark-time-per-NA.png "Benchmark time vs number annotations")

![Timings vs size of annotations for different numbers of annotations \label{time_per_sa}](figures/benchmark-time-per-SA.png "Benchmark time vs size of annotations")
